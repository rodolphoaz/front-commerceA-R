@extends('admin.layouts.app', ['title' => 'Lista de Endereco de Cobrança'])

@section('content')
    @include('admin.pages.partials.header', [
        'title' =>'Lista de Endereco de Cobranças',
        'description' => 'Exibindo todos os tipos de Endereco de Cobranças cadastradas',
    ])
        ...
        <div class="card shadow">
            <div class="card-header border-0">  
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">{{ __('Listagem do Tipo de Endereco de Cobranças') }}</h3>
                    </div>
                    <div class="col-4 text-right">
                        <a href="{{ route('caricature.create') }}" class="btn btn-sm btn-primary">{{ __('Novo tipo de Endereco de Cobrança') }}</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
