@extends('admin.layouts.app', ['title' => 'Lista de Tipo de Pagamento'])

@section('content')
    @include('admin.pages.partials.header', [
        'title' =>'Lista de Tipo de Pagamentos',
        'description' => 'Exibindo todos os tipos de Tipo de Pagamentos cadastradas',
    ])
        ...
        <div class="card shadow">
            <div class="card-header border-0">  
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">{{ __('Listagem do Tipo de Tipo de Pagamentos') }}</h3>
                    </div>
                    <div class="col-4 text-right">
                        <a href="{{ route('caricature.create') }}" class="btn btn-sm btn-primary">{{ __('Novo tipo de Tipo de Pagamento') }}</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
