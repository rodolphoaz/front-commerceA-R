...
<a href="https://www.facebook.com/aercaricaturasonline">A&amp;R Caricaturas Online</a></blockquote></div>
        ...
        <div class="col-lg-4 col-md-6 single-footer-widget">
          ...
          <p>Cadaste-se e receba descontos e promoções exclusivas</p>
          <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=92a4423d01"
              method="get" class="form-inline">
              <input class="form-control" name="EMAIL" placeholder="Digite o seu melhor email" onfocus="this.placeholder = ''"
                onblur="this.placeholder = 'Your Email Address '" required="" type="email">
              <button class="click-btn btn btn-default">Cadastrar</button>
...
Copyright &copy;{{date('Y')}} All rights reserved <i class="" aria-hidden="true"></i> A&R CARICATURAS ONLINE By <a href="https://www.facebook.com/2TwoDev" target="_blank"> 2TWODEV - Consultoria de Sistemas</a>
    ...
    <a href="https://api.whatsapp.com/send?l=pt&amp;phone=5521981840572"><img src="{{asset('/img/whatsapp.png')}}" style="height:80px; position:fixed; bottom: 25px; right: 25px; z-index:100;" data-selector="img"></a>
  </footer>